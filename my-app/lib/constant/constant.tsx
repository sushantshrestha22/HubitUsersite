...
// export const API_URL = "https://api.tilottamacampus.edu.np/";
// export const API_URL = "https://hubmainback.hubit.com.np/";
...
export const designations = {
  principal: "principal",
  chairman: "executive_chairman",
  manager: "managing_director",
};
export const studentDesignation = {
  president: "President",
  vice: "Vice-President",
  secretary: "Secretary",
  joint: "Joint-Secretary",
  treasurer: "Treasurer",
  member: "Member",
};
